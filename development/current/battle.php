...
switch($_GET['act'])
{
	case "attack":
		...
		if ($enemy->level < ($player->level - $setting->battle_min_level)) //Level limit can be changed in GM panel
		{
			include("templates/private_header.php");
	...
	case "search":
		...
		echo "<table width=\"100%\">\n";
		echo "<tr><th width=\"50%\">" . $lang['keyword_username'] . "</th><th width=\"20%\">" . $lang['keyword_level'] . "</th><th width=\"30%\">" . $lang['keyword_battle'] . "</a></th></tr>\n";
